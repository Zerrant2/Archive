...
class ARView extends StatefulWidget {
  ...
  /// Enables ARCore Depth API on Android. Disabled by default because the
  /// current SceneView fork is more stable across devices without it.
          ...
          return Column(children: [
            ...
            Expanded(
                child: PlatformARView(Theme.of(context).platform).build(
                    ...
                    enableDepth: widget.enableDepth)),
          ]);
        }
