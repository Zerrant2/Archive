...
class ArView(
    ...
    id: Int,
    private val enableDepth: Boolean,
) : PlatformView {
        ...
        try {
            ...
            sceneView.session?.let { session ->
                session.configure(session.config.apply {
                    depthMode = if (
                        enableDepth && session.isDepthModeSupported(Config.DepthMode.AUTOMATIC)
                    ) {
