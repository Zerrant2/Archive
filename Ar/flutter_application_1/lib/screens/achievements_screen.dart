...
class _AchievementCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final double expandedWidth = MediaQuery.of(context).size.width - 135;
        ...
        children: [
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: isExpanded
                        ? [BoxShadow(color: Colors.black.withValues(alpha: 0.1), offset: const Offset(2, 0), blurRadius: 4)]
                        : null,
                  ),
                  child: Row(
                    ...
                    children: [
                      if (isExpanded)
                        Expanded(
                          child: Padding(
                            padding: const EdgeInsets.only(left: 70, right: 1, top: 16, bottom: 16),
                            child: Column(
                              ...
                              children: [
                                const Text(
                                  "Как получить",
                                  style: TextStyle(color: AppColors.whiteText, fontSize: 12, fontWeight: FontWeight.w800),
                                ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: 121,
              decoration: BoxDecoration(
                gradient: achievement.isUnlocked ? AppColors.redGradient : null,
